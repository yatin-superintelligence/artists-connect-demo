...
export const CHAT_CONNECTIONS: Connection[] = [
  ...
  },
  {
    ...
    profile: {
      ...
      distance: '3 km away',
      bio: 'Structure is my language, and form is my art. As an architect and sculptor, I build monuments to persistence, finding beauty in the industrial, the raw, and the unfinished. I appreciate the interplay of dark wood, poured concrete, and intellectual depth. I value artistic connections that challenge my blueprints, people who can inhabit the spaces I design with creative intensity. Exploring the architecture of ideas and collaborating on something tangible is my pursuit.',
  ...
  },
  {
    ...
    profile: {
      ...
      distance: '3 km away',
      bio: 'Lines, angles, and the perfect curve of a horizon: my mind is always drafting the next concept. As an architect and draughtsman, I appreciate the precision of a well-executed plan, but I know that the most breathtaking structures are built on inspiration. I’m a student of history and a chaser of storms, finding peace in the eye of the hurricane. I value honesty as much as I value structural integrity. Sketching out a new project is the natural conclusion to a good conversation and shared creativity.',
  ...
  },
  {
    ...
    profile: {
      ...
      distance: '5 km away',
      bio: 'In a world screaming for attention, I choose the whisper. A writer and poet by nature, I find my truths in the quietude of a forest or the stillness of a morning meditation. My photography captures the untouched and the overlooked: the dew on a spiderweb, the fog rolling over a hill. I value an artistic dialogue that doesn\'t need to be loud to be profound. Stripping away the noise to find inspiration in the silence is where I begin. Minimalism is my aesthetic; depth is my requirement.',
    ...
    members: [
      {
        ...
        distance: '',
        bio: 'I view the world through a lens of high-contrast aesthetics. As a photographer and art director, I orchestrate moments of visual impact, curating scenes where every shadow plays a role. I believe in the power of collaboration and the collision of different artistic energies. My style is sharp, my vision is uncompromising, and I collaborate with fellow creatives who want to push the boundaries of visual storytelling. Whether behind the camera or designing the set, I demand authenticity. Creating art that leaves a lasting impression is what drives me.',
        images: ['https://images.pexels.com/photos/220417/pexels-photo-220417.jpeg?auto=compress&cs=tinysrgb&w=400'],
        isPro: true,
        artistTypes: ['Photographer', 'Art director', 'Stylist'],
        interests: ['Travel', 'Fashion', 'Photography', 'Cocktails', 'Luxury travel', 'Art', 'Music']
  ...
  },
  {
    ...
    profile: {
      ...
      distance: '2 km away',
      bio: 'My life is measured in movements and crescendos. As a cellist and composer, I speak a language without words, translating the deepest human experiences into resonance and vibration. I find solace in the resonance of wood and string, and I’m drawn to the slower, more deliberate tempos of creation. Collaboration is for those who can listen—really listen—to the silence between the notes. Spending an afternoon composing, with nothing but the sound of the water and the comfort of shared creativity, is my ideal.',
  ...
  },
  {
    ...
    profile: {
      ...
      distance: '4 km away',
      bio: 'History is not in the past; it is painted in the layers of the present. As an art historian and watercolorist, I spend my days decoding the stories hidden in brushstrokes and fading pigments. I see the world as a living museum, full of tragic heroes and beautiful ruins. Always inspired by a muse or fellow artist who understands that every scar is a signature and every flaw is a masterpiece. Wandering through galleries, debating the classics, and creating a new masterpiece together is the dream.',
  ...
  },
  {
    ...
    profile: {
      ...
      distance: '5 km away',
      bio: 'I am movement incarnate, a fleeting shape in the spotlight. As a contemporary dancer and choreographer, I do not just listen to the music; I become it. My body is my instrument, expressing the words I cannot speak. I find rhythm in the wind and melody in the silence. Collaboration is about moving with a partner, not necessarily on the dance floor, but in creative spirit—someone who understands the ebb and flow of energy. Creating a duet of artistic expression is the ultimate goal.',
  ...
  },
  {
    ...
    profile: {
      ...
      distance: '2 km away',
      bio: 'I carry my home in my heart and my stories in my songs. As a folk musician and writer, I travel light but feel deeply. I am drawn to the ancient wisdom of forests and the profound truth found in deep silence. I turned off the television ten years ago to tune into the frequency of the real world. Open to jamming with fellow artists, travelers who value authenticity over accumulation. Sitting by a fire, sharing a song, and listening to the music of the wild is where the truth is.',
